...
require 'doorkeeper/request/account_application'
...
module Doorkeeper
  module Request
    ...
    def token_strategy(strategy)
      get_strategy strategy, %w[password client_credentials authorization_code refresh_token account_application]
    rescue NameError
